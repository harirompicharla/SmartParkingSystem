...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <a class="col-md-2 slots totalslots" style="border-radius: 25px;" runat="server" onserverclick="TotalParkingSlots_ServerClick">
            <asp:Label ID="TotalParkingSlotsLbl" runat="server" Text="Total Parking Slots: "></asp:Label>
        </a>

        <a href="ParkingSlots.aspx" class="col-md-2 slots occupiedslots" style="border-radius: 25px;" runat="server" onserverclick="OccupiedParkingSlots_ServerClick">
            <asp:Label ID="OccupiedParkingSlotsLbl" runat="server" Text="Occupied Parking Slots: "></asp:Label>            
        </a>
        <a class="col-md-2 slots availableslots" style="border-radius: 25px;" runat="server" onserverclick="AvailableParkingSlots_ServerClick">
            <asp:Label ID="AvailableParkingSlotsLbl" runat="server" Text="Available Parking Slots: "></asp:Label> 
        </a>
    </div>
    <div class="row">
        <asp:GridView ID="ParkingDetailsGrid" runat="server" AutoGenerateColumns="false" Width="80%" HeaderStyle-BackColor="Wheat" AlternatingRowStyle-BackColor="WhiteSmoke"
            AllowPaging="true" PageSize="2" OnPageIndexChanging="ParkingDetailsGrid_PageIndexChanging">
            <Columns>
